...
2026-08-29, `container-thumbnail.webp` on 2026-08-30, and
`terraform-state-thumbnail.webp` on 2026-08-31, each as an
...
The twenty-three `*-sketch.svg` files are original hand-authored SVG line drawings
...
Redis Cluster, on 2026-08-30 for Container, and on 2026-08-31 for
Terraform State. Their line work is
